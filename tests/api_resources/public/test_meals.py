...
from freeapiapp.types.public import MealListResponse, MealRetrieveResponse
...
class TestMeals:
    ...
    def test_method_retrieve(self, client: Freeapiapp) -> None:
        meal = client.public.meals.retrieve(
            "1",
        )
        assert_matches_type(MealRetrieveResponse, meal, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Freeapiapp) -> None:
        response = client.public.meals.with_raw_response.retrieve(
            "1",
        )
    ...
    def test_streaming_response_retrieve(self, client: Freeapiapp) -> None:
        with client.public.meals.with_streaming_response.retrieve(
            "1",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Freeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `meal_id` but received ''"):
            client.public.meals.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: Freeapiapp) -> None:
        meal = client.public.meals.list()
        assert_matches_type(MealListResponse, meal, path=["response"])
    ...
    def test_raw_response_list(self, client: Freeapiapp) -> None:
        response = client.public.meals.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Freeapiapp) -> None:
        with client.public.meals.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncMeals:
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.public.meals.with_raw_response.retrieve(
            "1",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.public.meals.with_streaming_response.retrieve(
            "1",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `meal_id` but received ''"):
            await async_client.public.meals.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncFreeapiapp) -> None:
        meal = await async_client.public.meals.list()
        assert_matches_type(MealListResponse, meal, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.public.meals.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.public.meals.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
from freeapiapp.types.public import CatListResponse, CatRetrieveResponse
...
class TestCats:
    ...
    def test_method_retrieve(self, client: Freeapiapp) -> None:
        cat = client.public.cats.retrieve(
            "12",
        )
        assert_matches_type(CatRetrieveResponse, cat, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Freeapiapp) -> None:
        response = client.public.cats.with_raw_response.retrieve(
            "12",
        )
    ...
    def test_streaming_response_retrieve(self, client: Freeapiapp) -> None:
        with client.public.cats.with_streaming_response.retrieve(
            "12",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Freeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cat_id` but received ''"):
            client.public.cats.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: Freeapiapp) -> None:
        cat = client.public.cats.list()
        assert_matches_type(CatListResponse, cat, path=["response"])
    ...
    def test_raw_response_list(self, client: Freeapiapp) -> None:
        response = client.public.cats.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Freeapiapp) -> None:
        with client.public.cats.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncCats:
    ...
    async def test_method_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        cat = await async_client.public.cats.retrieve(
            "12",
        )
        assert_matches_type(CatRetrieveResponse, cat, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.public.cats.with_raw_response.retrieve(
            "12",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        cat = await response.parse()
        assert_matches_type(CatRetrieveResponse, cat, path=["response"])

    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.public.cats.with_streaming_response.retrieve(
            "12",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cat_id` but received ''"):
            await async_client.public.cats.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncFreeapiapp) -> None:
        cat = await async_client.public.cats.list()
        assert_matches_type(CatListResponse, cat, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.public.cats.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.public.cats.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

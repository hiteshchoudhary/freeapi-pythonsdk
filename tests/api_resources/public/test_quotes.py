...
from freeapiapp.types.public import QuoteListResponse, QuoteRandomResponse, QuoteRetrieveResponse
...
class TestQuotes:
    ...
    def test_method_retrieve(self, client: Freeapiapp) -> None:
        quote = client.public.quotes.retrieve(
            "10",
        )
    ...
    def test_raw_response_retrieve(self, client: Freeapiapp) -> None:
        response = client.public.quotes.with_raw_response.retrieve(
            "10",
        )
    ...
    def test_streaming_response_retrieve(self, client: Freeapiapp) -> None:
        with client.public.quotes.with_streaming_response.retrieve(
            "10",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Freeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `quote_id` but received ''"):
            client.public.quotes.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: Freeapiapp) -> None:
        quote = client.public.quotes.list()
    ...
    def test_raw_response_list(self, client: Freeapiapp) -> None:
        response = client.public.quotes.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Freeapiapp) -> None:
        with client.public.quotes.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_random(self, client: Freeapiapp) -> None:
        quote = client.public.quotes.random()
        assert_matches_type(QuoteRandomResponse, quote, path=["response"])

    @parametrize
    def test_raw_response_random(self, client: Freeapiapp) -> None:
        response = client.public.quotes.with_raw_response.random()
    ...
    def test_streaming_response_random(self, client: Freeapiapp) -> None:
        with client.public.quotes.with_streaming_response.random() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncQuotes:
    ...
    async def test_method_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        quote = await async_client.public.quotes.retrieve(
            "10",
        )
        assert_matches_type(QuoteRetrieveResponse, quote, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.public.quotes.with_raw_response.retrieve(
            "10",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.public.quotes.with_streaming_response.retrieve(
            "10",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `quote_id` but received ''"):
            await async_client.public.quotes.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncFreeapiapp) -> None:
        quote = await async_client.public.quotes.list()
        assert_matches_type(QuoteListResponse, quote, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.public.quotes.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.public.quotes.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_random(self, async_client: AsyncFreeapiapp) -> None:
        quote = await async_client.public.quotes.random()
        assert_matches_type(QuoteRandomResponse, quote, path=["response"])

    @parametrize
    async def test_raw_response_random(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.public.quotes.with_raw_response.random()
    ...
    async def test_streaming_response_random(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.public.quotes.with_streaming_response.random() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

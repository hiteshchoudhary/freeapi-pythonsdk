...
class TestAvatar:
    ...
    def test_method_update(self, client: Freeapiapp) -> None:
        avatar = client.users.avatar.update()
    ...
    def test_method_update_with_all_params(self, client: Freeapiapp) -> None:
        avatar = client.users.avatar.update(
            avatar=b"raw file contents",
        )
        assert_matches_type(AvatarUpdateResponse, avatar, path=["response"])

    @parametrize
    def test_raw_response_update(self, client: Freeapiapp) -> None:
        response = client.users.avatar.with_raw_response.update()
    ...
    def test_streaming_response_update(self, client: Freeapiapp) -> None:
        with client.users.avatar.with_streaming_response.update() as response:
...
class TestAsyncAvatar:
    ...
    async def test_method_update(self, async_client: AsyncFreeapiapp) -> None:
        avatar = await async_client.users.avatar.update()
        assert_matches_type(AvatarUpdateResponse, avatar, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.users.avatar.with_raw_response.update()
    ...
    async def test_streaming_response_update(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.users.avatar.with_streaming_response.update() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

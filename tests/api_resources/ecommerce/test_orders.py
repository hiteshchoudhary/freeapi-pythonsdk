...
class TestOrders:
    ...
    def test_method_retrieve(self, client: Freeapiapp) -> None:
        order = client.ecommerce.orders.retrieve(
            "649e7bfcdbf96264731f5a0c",
        )
        assert_matches_type(OrderRetrieveResponse, order, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Freeapiapp) -> None:
        response = client.ecommerce.orders.with_raw_response.retrieve(
            "649e7bfcdbf96264731f5a0c",
        )
    ...
    def test_streaming_response_retrieve(self, client: Freeapiapp) -> None:
        with client.ecommerce.orders.with_streaming_response.retrieve(
            "649e7bfcdbf96264731f5a0c",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Freeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `order_id` but received ''"):
            client.ecommerce.orders.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncOrders:
    ...
    async def test_method_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        order = await async_client.ecommerce.orders.retrieve(
            "649e7bfcdbf96264731f5a0c",
        )
        assert_matches_type(OrderRetrieveResponse, order, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.ecommerce.orders.with_raw_response.retrieve(
            "649e7bfcdbf96264731f5a0c",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.ecommerce.orders.with_streaming_response.retrieve(
            "649e7bfcdbf96264731f5a0c",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncFreeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `order_id` but received ''"):
            await async_client.ecommerce.orders.with_raw_response.retrieve(
                "",
            )

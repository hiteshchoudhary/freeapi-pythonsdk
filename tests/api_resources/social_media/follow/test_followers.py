...
class TestFollowers:
    ...
    def test_method_list(self, client: Freeapiapp) -> None:
        follower = client.social_media.follow.followers.list(
    ...
    def test_raw_response_list(self, client: Freeapiapp) -> None:
        response = client.social_media.follow.followers.with_raw_response.list(
            username="abdiel_breitenberg22",
        )
    ...
    def test_streaming_response_list(self, client: Freeapiapp) -> None:
        with client.social_media.follow.followers.with_streaming_response.list(
            username="abdiel_breitenberg22",
        ) as response:
    ...
    def test_path_params_list(self, client: Freeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `username` but received ''"):
            client.social_media.follow.followers.with_raw_response.list(
                username="",
            )
...
class TestAsyncFollowers:
    ...
    async def test_method_list(self, async_client: AsyncFreeapiapp) -> None:
        follower = await async_client.social_media.follow.followers.list(
            username="abdiel_breitenberg22",
        )
        assert_matches_type(FollowerListResponse, follower, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncFreeapiapp) -> None:
        response = await async_client.social_media.follow.followers.with_raw_response.list(
            username="abdiel_breitenberg22",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncFreeapiapp) -> None:
        async with async_client.social_media.follow.followers.with_streaming_response.list(
            username="abdiel_breitenberg22",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncFreeapiapp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `username` but received ''"):
            await async_client.social_media.follow.followers.with_raw_response.list(
                username="",
            )

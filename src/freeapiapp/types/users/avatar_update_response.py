...
__all__ = ["AvatarUpdateResponse", "Data", "DataAvatar"]
...
class Data(BaseModel):
    ...
    email_verification_expiry: Optional[str] = FieldInfo(alias="emailVerificationExpiry", default=None)

    email_verification_token: Optional[str] = FieldInfo(alias="emailVerificationToken", default=None)

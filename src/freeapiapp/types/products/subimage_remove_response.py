...
__all__ = ["SubimageRemoveResponse", "Data", "DataMainImage"]
...
class Data(BaseModel):
    ...
    sub_images: Optional[List[object]] = FieldInfo(alias="subImages", default=None)

    updated_at: Optional[str] = FieldInfo(alias="updatedAt", default=None)


class SubimageRemoveResponse(BaseModel):

...
__all__ = ["ProductDeleteResponse", "Data", "DataDeletedProduct"]


class DataDeletedProduct(BaseModel):
...
class Data(BaseModel):
    deleted_product: Optional[DataDeletedProduct] = FieldInfo(alias="deletedProduct", default=None)

...
__all__ = ["AddressDeleteResponse", "Data", "DataDeletedAddress"]


class DataDeletedAddress(BaseModel):
...
class Data(BaseModel):
    deleted_address: Optional[DataDeletedAddress] = FieldInfo(alias="deletedAddress", default=None)
